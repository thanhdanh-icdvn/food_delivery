...
const Drawer: React.FC<DrawerProps> = ({ isShow, toggleShow }: DrawerProps) => {
  return (
    <div
      className={`${
        isShow ? 'translate-x-0' : '-translate-x-80'
      } fixed z-40 h-screen p-4 overflow-y-auto bg-white  shadow-mat-1 transition transform duration-300 ease-in-out w-80`}
      tabIndex={-1}
    ...
    >
      ...
      <p className='mb-6 text-sm text-gray-500 dark:text-gray-400'>
        ...
        <Link href='#' className='text-blue-600 underline dark:text-blue-500 hover:no-underline'>
          limited-time sale
        </Link>{' '}
